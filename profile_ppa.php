                    ...
                    <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="profile_ppa">Profile PPA</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mu-page-breadcrumb-area">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="index">Home</a></li>
                            <li><a class="active" href="profile_ppa">Profile PPA</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mu-latest-course-single">
                                                <figure class="mu-latest-course-img">
                                                    <a href="#"><img src="assets/img/slider/3-bg-sekolah.jpg" alt="img" /></a>
                                                    <figcaption class="mu-latest-course-imgcaption">
                                                    </figcaption>
                                                </figure>
                                                <div class="mu-latest-course-single-content">
                                                    <h2><a href="#">Profile Pusat Pelayanan Anak</a></h2>
                                                    Deskripsi</b>
                                                    </h4>
                                                    <p>
                                                        Pusat Pengembangan Anak (PPA) merupakan suatu lembaga nirbala yang didirikan dalam rangka memberikan pelayanan kepada masyarakat secara umum. Pusat Pengembangan Anak adalah bentuk utama kemitraan Yayasan Compassion Indonesia (YCI) dengan gereja mitra.
                                                        Melalui Pusat Pengembangan Anak (PPA), gereja mitra menjangkau dan melayani anak yang membutuhkan. Anak-anak dilayani dalam Pusat Pengembangan Anak (PPA) mulai dari usia tiga tahun sampai dua puluh
                                                        tahun. Dengan pelayanan dalam jangka waktu yang panjang, Pusa
                                                    </p>
                                                    <p>
                                                    ...
                                                    <p>
                                                        Pusat Pengembangan Anak (PPA) merupakan suatu lembaga pengembangan bagi anak-anak dari keluarga tidak mampu yang bekerja sama dengan suatu lembaga Pelayanan Pengembangan Anak yaitu Yayasan Compassion yang bertempat di Sulawesi Utara (Manado).
                                                    </p>

                                                    <br>

                                                    <h4 id="visi&misi"><b>Visi dan Misi</b></h4>
                                                    <p>Berikut adalah isi Visi dan Misi dari PPA IO0496 Maranatha:</p>
                                                    <p>
                                                        Visi
                                                    </p>
                                                    <blockquote>
                                                        <p>
                                                            <i>“Terwujudnya pusat pengembangan anak secara holistic yang
                                                    ...
                                                    <blockquote>
                                                        <p>
                                                            <i>“Sebagai tanggapan atas Anugerah Tuhan maka kami sepakat
                                                                untuk melayani dan membina
                                                                anak-anak PPA IO0496 secara holistic untuk menjadi
                                                                pemimpin masa depan yang takut akan
                                                                Tuhan.”</i>
                                                        </p>
                                                    </blockquote>
                                                    ...
                                                    <h4 id="struktur_ppa"><b>Struktur Organisasi</b></h4>
                                                    <figure class="mu-latest-course-img">
                                                        <a href="#"><img src="assets/img/slider/struktur.jpg" alt="img" /></a>
                                                        <figcaption class="mu-latest-course-imgcaption">
                                                            <br><br><br>
                                                        </figcaption>
                                                    </figure>

                                                    <h4><b id="perkembangan_anak">Perkembangan Anak</b></h4>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center" colspan="4">
                                                                        <h3>Silakan
                                                                            <a style="color: blue;" href="login">login</a> terlebih dahulu untuk melihat data selengkapnya</h3>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
