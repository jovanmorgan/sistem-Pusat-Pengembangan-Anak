...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <!-- Tabs Titles -->
            <h2 class="active text-center"> Form Login </h2>
            <br>
            <!-- Icon -->
            <div class="fadeIn first">
                <img src="assets/img/2-logo.png" width="50px" id="icon" alt="User Icon" />
            </div>
            <br>
            <!-- Login Form -->
                        ...
                        setTimeout(function() {
                            switch (responseArray[2].trim()) {
                                case "admin":
                                    ...
                                    break;
                                case "pimpinan":
                                    window.location.href = "pengguna/pimpinan/pimpinan";
                                    break;
                                case "orang_tua":
                                    window.location.href = "pengguna/orang_tua/orang_tua";
                                    break;
                                case "sponsor":
                                    window.location.href = "pengguna/sponsor/sponsor";
                                    break;
                                default:
