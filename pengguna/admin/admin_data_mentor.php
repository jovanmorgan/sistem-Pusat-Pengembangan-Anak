...
<body class="white-content">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="mentor/tambah.php" method="POST"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="mentor/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_mentor" name="id_mentor">
                                <div class="form-group">
                                    <label for="nama">Nama :</label>
                                ...
                                <script>
                                function openEditModal(id_mentor, nama, tempat_lahir, tanggal_lahir, jk, nomor_hp) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_mentor').value = id_mentor;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data mentor</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="mentor/export" target="_blank"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'mentor/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'mentor/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'mentor/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'mentor/load_table.php', true);
        xhrTable.send();
    }
    </script>
