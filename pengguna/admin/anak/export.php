            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h3 class="text-center">Data Anak</h3>
                    </div>
                            ...
                            <table id="example" class="table align-items-center mb-0 display nowrap">
                                <thead class=" text-primary">
                                    <tr>
                                        ...
                                        <th class="text-center">Hoby </th>
                                        <th class="text-center">Jenjang Umur </th>
                                        <th class="text-center">Alamat </th>
                                    </tr>
                                </thead>
                                <tbody><?php // Lakukan koneksi ke database
                                        include '../../../koneksi.php';
...
FROM anak LEFT JOIN kelas ON anak.id_kelas=kelas.id_kelas";
                            ...
                            $('.fixed-plugin .background-color span').click(
                                function() {
                                    ...
                                    if ($main_panel.length != 0) {
                                        $main_panel.attr('data',
                                            new_color);
                                    }

                                    if ($full_page.length != 0) {
                                        $full_page.attr('filter-color',
                                            new_color);
                                    }

                                    if ($sidebar_responsive.length !=
                                        0) {
                                        $sidebar_responsive.attr('data',
                                            new_color);
                                    }
                                }
