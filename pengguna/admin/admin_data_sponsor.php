...
<body class="white-content">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="sponsor/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="asal_negara">Asal Negara :</label>
                                    <input type="text" class="form-control" id="editasal_negara" name="asal_negara"
                                        required>
                                </div>
                                <script>
                                function openEditModal(id_sponsor, nama, username, password, jk, usia,
                                    ...
                                    document.getElementById('editasal_negara').value = asal_negara;
    ...
    ";
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data sponsor</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="sponsor/export" target="_blank"
            ...
            <button class='btn btn-info btn-sm' onclick='window.location.href=\"detail_anak.php?id_sponsor=" . $row['id_sponsor'] . "\"'>Lihat Detail Anak</button>
          </td>";
                                                    echo "<td class='text-center'>
