...
<body class="white-content">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="perkembangan/tambah.php" method="POST"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="perkembangan/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_perkembangan" name="id_perkembangan">
                                <div class="form-group">
                                    <label for="id_anak">anak:</label>
                                ...
                                <script>
                                function openEditModal(id_perkembangan, id_anak, id_kegiatan) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_perkembangan').value = id_perkembangan;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'perkembangan/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'perkembangan/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'perkembangan/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'perkembangan/load_table.php', true);
        xhrTable.send();
    }
    </script>
