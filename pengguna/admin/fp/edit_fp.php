...
$select_query = "SELECT fp FROM admin WHERE username = '$username'";
...
// Update nama gambar di tabel admin berdasarkan username
$update_query = "UPDATE admin SET fp = '$filename' WHERE username = '$username'";
