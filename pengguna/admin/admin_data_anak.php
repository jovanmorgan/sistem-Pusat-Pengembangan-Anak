                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="anak/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hoby" name="hoby" required>
                                </div>
                                <div class="form-group">
                                    <label for="jenjang_umur">Jenjang Umur :</label>
                                    <input type="text" class="form-control" id="editjenjang_umur" name="jenjang_umur"
                                        required>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="anak/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_anak" name="id_anak">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
                                ...
                                <div class="form-group">
                                    <label for="hoby">Hoby :</label>
                                    <input type="text" class="form-control" id="edithoby" name="hoby" required>
                                </div>
                                <div class="form-group">
                                    <label for="jenjang_umur">Jenjang Umur :</label>
                                    <input type="text" class="form-control" id="editjenjang_umur" name="jenjang_umur"
                                ...
                                <script>
                                function openEditModal(id_kelas, id_anak, nama, tempat_lahir, tanggal_lahir, jk, hoby,
                                    jenjang_umur, alamat) {
                                    // Isi data ke dalam form edit
                                    var alamat_data = alamat.replace(/<br\s*\/?>/gi, '\n');
                                    ...
                                    document.getElementById('edithoby').value = hoby;
                                    document.getElementById('editjenjang_umur').value = jenjang_umur;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data anak</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="anak/export" target="_blank" class="btn btn-info btn-block"
...
LEFT JOIN kelas ON anak.id_kelas = kelas.id_kelas";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'anak/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'anak/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'anak/hapus.php', true);
                    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                    xhr.onload = function() {
                        // window.location.href = 'anak/hapus.php';
                        // tolong  berikan perpindahan halaman pada bagian ini
                        // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                        loding.style.display = 'none';
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'anak/load_table.php', true);
        xhrTable.send();
    }
    </script>
