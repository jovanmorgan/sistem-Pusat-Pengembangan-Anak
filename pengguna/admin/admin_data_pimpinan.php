...
<body class="white-content">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="pimpinan/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="nomor_hp" name="nomor_hp"
                                        required>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="pimpinan/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_pimpinan" name="id_pimpinan">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_terakhir">Pendidikan :</label>
                                    <select class="form-control" id="editpendidikan_terakhir" name="pendidikan_terakhir"
                                        required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <option value="S1">S1</option>
                                        <option value="S2">S2</option>
                                ...
                                <div class="form-group">
                                    <label for="nomor_hp">Nomor Telepon:</label>
                                    <input type="number" min="0" class="form-control" id="editnomor_hp" name="nomor_hp"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat:</label>
                                ...
                                <!-- js edit -->
                                <script>
                                function openEditModal(id_pimpinan, nama, username, password, tempat_lahir,
                                    tanggal_lahir, jk, jabatan, pendidikan_terakhir, nomor_hp, alamat, foto) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_pimpinan').value = id_pimpinan;
                                    ...
                                    document.getElementById('editpendidikan_terakhir').value = pendidikan_terakhir;
                                    document.getElementById('editnomor_hp').value = nomor_hp;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data pimpinan</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="pimpinan/export" target="_blank"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'pimpinan/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'pimpinan/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'pimpinan/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'pimpinan/load_table.php', true);
        xhrTable.send();
    }
    </script>
