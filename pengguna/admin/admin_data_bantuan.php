                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="bantuan/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_anak" name="id_anak" required>
                                        ...
                                        // Query untuk mendapatkan data anak
                                        $query = "SELECT id_anak, nama FROM anak";
                                        ...
                                        if ($result) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_anak'] . "'>" . $row['nama'] . "</option>";
                                            }
                                ...
                                <div class="form-group">
                                    <label for="id_sponsor">Sponsor Yang Membantu:</label>
                                    <select class="form-control" id="id_sponsor" name="id_sponsor" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                        include '../../koneksi.php';

                                        // Query untuk mendapatkan data sponsor
                                        $query = "SELECT id_sponsor, nama FROM sponsor";
                                        $result = $koneksi->query($query);
                                        ...
                                        if ($result) {
                                            // Loop melalui hasil query dan tambahkan setiap opsi ke dalam select
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_sponsor'] . "'>" . $row['nama'] . "</option>";
                                            }
                                            // Bebaskan hasil query
                                            $result->free();
                                        } else {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="bantuan/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_bantuan" name="id_bantuan">
                                <div class="form-group">
                                    <label for="id_anak">anak:</label>
                                    <select class="form-control" id="editid_anak" name="id_anak" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                        include '../../koneksi.php';
                                ...
                                <div class="form-group">
                                    <label for="nama_bantuan">Nama Bantuan :</label>
                                    <input type="text" class="form-control" id="editnama_bantuan" name="nama_bantuan"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="id_sponsor">Sponsor Yang Membantu :</label>
                                    <select class="form-control" id="editid_sponsor" name="id_sponsor" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                        include '../../koneksi.php';
                                ...
                                <script>
                                function openEditModal(id_bantuan, id_anak, nama_bantuan, id_sponsor) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_bantuan').value = id_bantuan;
                                    document.getElementById('editid_anak').value = id_anak;
                                    document.getElementById('editnama_bantuan').value = nama_bantuan;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data bantuan</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="bantuan/export" target="_blank"
