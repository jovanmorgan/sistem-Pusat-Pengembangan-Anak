                            ...
                            <form id="form_tambah" action="kelas/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_mentor" name="id_mentor" required>
                                        ...
                                        $query = "SELECT id_mentor, nama FROM mentor";
                                        ...
                                        if ($result) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_mentor'] . "'>" . $row['nama'] . "</option>";
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="tahun_ajaran" name="tahun_ajaran"
                                        required>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="kelas/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="nama_kelas">Nama Kelas:</label>
                                    <input type="text" class="form-control" id="Editnama_kelas" name="nama_kelas"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="id_mentor">mentor:</label>
                                    <select class="form-control" id="Editid_mentor" name="id_mentor" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                        include '../../koneksi.php';
                                ...
                                <div class="form-group">
                                    <label for="tahun_ajaran">Tahun Ajaran :</label>
                                    <input type="date" class="form-control" id="Edittahun_ajaran" name="tahun_ajaran"
                                        required>
                                </div>
                                <script>
                                function openEditModal(id_kelas, id_mentor, nama_kelas, tahun_ajaran) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('Editid_kelas').value = id_kelas;
                                    document.getElementById('Editnama_kelas').value = nama_kelas;
                                    document.getElementById('Editid_mentor').value = id_mentor;
                                    document.getElementById('Edittahun_ajaran').value = tahun_ajaran;
                                        ...
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="kelas/export" target="_blank"
