                            ...
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        <?php endif; ?>
                                        <h5 class="title"><?php echo $sponsor['username']; ?></h5>
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li class="nav-link active"><a href="fp" class="nav-item dropdown-item">Profile</a>
                                    </li>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_sponsor" id="id_sponsor"
                                            value="<?php echo $sponsor['id_sponsor']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="nama" name="nama"
                                                    id="nama" value="<?php echo $sponsor['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username"
                                                    ...
                                                    value="<?php echo $sponsor['username']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Password"
                                                    ...
                                                    value="<?php echo $sponsor['password']; ?>">
                                            </div>
                                        </div>
                                    </div>
