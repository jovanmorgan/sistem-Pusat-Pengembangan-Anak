...
$select_query = "SELECT fp FROM sponsor WHERE username = '$username'";
...
// Update nama gambar di tabel sponsor berdasarkan username
$update_query = "UPDATE sponsor SET fp = '$filename' WHERE username = '$username'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel sponsor
