...
$select_query = "SELECT fp FROM pimpinan WHERE username = '$username'";
...
// Update nama gambar di tabel pimpinan berdasarkan username
$update_query = "UPDATE pimpinan SET fp = '$filename' WHERE username = '$username'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel pimpinan
