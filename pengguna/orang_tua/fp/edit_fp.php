...
$select_query = "SELECT fp FROM orang_tua WHERE username = '$username'";
...
// Update nama gambar di tabel orang_tua berdasarkan username
$update_query = "UPDATE orang_tua SET fp = '$filename' WHERE username = '$username'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel orang_tua
