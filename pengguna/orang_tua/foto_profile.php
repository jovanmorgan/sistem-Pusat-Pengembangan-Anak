            ...
            <div class="sidebar-wrapper badge-info">
                <div class="logo">
                    <a href="javascript:void(0)" class="simple-text logo-mini">
                        <img src="../../assets/img/2-logo.png" width="50px" alt="" style="position: relative; bottom: 3px;">
                    </a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $orang_tua['username']; ?></h5>
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li class="nav-link active"><a href="fp" class="nav-item dropdown-item">Profile</a></li>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_orang_tua" id="id_orang_tua" value="<?php echo $orang_tua['id_orang_tua']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="nama" name="nama" id="nama" value="<?php echo $orang_tua['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?php echo $orang_tua['username']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $orang_tua['password']; ?>">
                                            </div>
                                        </div>
                                    </div>
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright">
            ...
            </script> Dibuat Oleh Febriani <i class="tim-icons icon-heart-2"></i>
        </div>
    </div>
</footer>
        </div>
