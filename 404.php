            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mu-error-area">
                        <p>Oops! Data yang anda cari tidak ada !</p>
                        <span>Silakan masukan kata kunci yang sesuai untuk menemunkan halaman yang kamu cari.</span>
                        <h2>404</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="mu-footer-widget">
                                ...
                                <p>Yuk Login! Agar Dapat Melihat Data Lebih Lengkap</p>
                                    <a href="login" class="mu-subscribe-btn">
